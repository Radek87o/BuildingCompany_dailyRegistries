...
<title>Wybierz kierownika</title>
</head>
<body>
	...
	<div class="container">
		<form:form action="wybierzDateProjektu" modelAttribute="project" method="POST" class="form-horizontal">
			<div class="form-group">
					...
					<div class="col-md-4" style="padding-top: 10px">
						<form:select path="id" class="form-control">
							<c:forEach var="tempProject" items="${allProjects}">
								<form:option value="${tempProject.id}">${tempProject.projectName}</form:option>
							</c:forEach>
						</form:select>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-4" style="padding-top: 10px">
						<button type="submit" class="btn btn-success btn-block">Przejdź do wyboru daty</button>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4" style="padding-top: 10px">
