		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<h1 class="mt-0 mb-3 text-white">Lista rejestrów</h1>
				</div>
			</div>
		</div>
	</section>
		...
		<table>
			<tbody>
				...
				<c:forEach var="tempRegistry" items="${registries}">
					...
					<tr>
						<%-- <td><label>${tempRejestr.projekt.nazwaProjektu}</label></td> --%>
						<td><label>${tempRegistry.employee.firstName}&nbsp;${tempRegistry.employee.lastName}</label></td>
						<%-- <td><label><fmt:formatDate type="date" value="${tempRejestr.data}"/></label></td> --%>
